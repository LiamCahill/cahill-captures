...
// node_modules/@convex-dev/sharded-counter/dist/esm/client/index.js
var ShardedCounter = class {
  /**
  ...
  constructor(component, options) {
    ...
    __publicField(this, "shardsForKey");
    // Keep track of the shard for each key, so multiple mutations on the same key
    // will use the same shard.
    __publicField(this, "stickyShard");
    this.component = component;
    this.stickyShard = {};
    const defaultShards = options == null ? void 0 : options.defaultShards;
    this.shardsForKey = (name) => {
      var _a;
      const explicitShards = (_a = options == null ? void 0 : options.shards) == null ? void 0 : _a[name];
  ...
  async add(ctx, name, count = 1) {
    ...
    const shard = await ctx.runMutation(this.component.public.add, {
      name,
      count,
      shard: (_a = this.stickyShard) == null ? void 0 : _a[name],
...
//# sourceMappingURL=@convex-dev_sharded-counter.js.map
